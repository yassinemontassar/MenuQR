                      ...
                      <CardContent>
                        <div className="aspect-square relative">
                          <Image
                            ...
                            sizes="(max-width: 768px) 320px, (min-width: 768px) and (max-width: 1200px) 640px, 1280px" // Improved responsiveness
                            className="rounded-xl" // Use object-cover for better control
                          />
                        </div>
                      </CardContent>
